...
open class Legend: ComponentBase
{
    ...
    @objc open func getMaximumEntrySize(withFont font: NSUIFont) -> CGSize
    {
        ...
        for entry in entries
        {
            ...
            let size = (label as String?)!.size(withAttributes: [NSAttributedString.Key.font: font])
    ...
    @objc open func calculateDimensions(labelFont: NSUIFont, viewPortHandler: ViewPortHandler)
    {
        ...
        case .vertical:
            ...
            for i in 0 ..< entryCount
            {
                ...
                if label != nil
                {
                    let size = (label as NSString?)!.size(withAttributes: [NSAttributedString.Key.font: labelFont])
